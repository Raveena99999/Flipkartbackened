        ...
        <SimpleGrid columns={{ base: 1, sm: 2, md: 6 }} spacing={8}>
          <Stack color="gray" align={"flex-start"}>
            ...
            <Box
              ...
              fontSize="14px"
              as="a"
              href={"https://www.flipkart.com/corporate-information"}
            >
          ...
          <Stack color="gray" align={"flex-start"}>
            ...
            <Box
              ...
              as="a"
              href={
                "https://seller.flipkart.com/fiv?otracker=${otracker}_navlinks"
              }
            >
              Report Infringement
            </Box>
          ...
          <Stack color="gray" align={"flex-start"}>
            ...
            <Box
              ...
              as="a"
              href={
                "https://www.flipkart.com/pages/returnpolicy?otracker=${otracker}_navlinks"
              }
            >
              Cancellation & Returns
            </Box>
            <Box
              ...
              as="a"
              href={
                "https://www.flipkart.com/pages/terms?otracker=${otracker}_navlinks"
              }
            >
              Terms Of Use
            </Box>
            <Box
              ...
              as="a"
              href={
                "https://www.flipkart.com/pages/paymentsecurity?otracker=${otracker}_navlinks"
              }
            >
              Security
            </Box>
            ...
            <Box
              ...
              as="a"
              href={
                "https://www.flipkart.com/sitemap?otracker=${otracker}_navlinks"
              }
            >
              Sitemap
            </Box>
            <Box
              ...
              as="a"
              href={
                "https://www.flipkart.com/pages/grievance-redressal-mechanism?otracker=${otracker}_navlinks"
              }
            >
              Grievance Redressal
            </Box>
            <Box
              ...
              as="a"
              href={
                "https://www.flipkart.com/pages/ewaste-compliance-tnc?otracker=${otracker}_navlinks"
              }
            >
              EPR Compliance
            </Box>
